...
const BrandDashboard = () => {
  ...
  return (
    ...
    >
      ...
      {message.text && (
        <div className={`mb-10 p-5 rounded-2xl flex items-center gap-4 font-black shadow-2xl border animate-reveal-scale ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="dashboard-card">
               <div className="flex justify-between items-center mb-10">
                 <h3 className="text-2xl font-black text-on-surface tracking-tight uppercase flex items-center gap-3">
               ...
               <div className="space-y-8">
                  ...
                  <div className="pt-6 border-t border-outline-variant/5 grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <span className="px-3 py-1 rounded-lg bg-surface-container-high text-xs font-black text-secondary border border-secondary/10">Multi-Channel</span>
                    </div>
                    <div>
                      <span className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.3em] block mb-1">Status</span>
                      <span className="px-3 py-1 rounded-lg bg-emerald-500/10 text-xs font-black text-emerald-400 border border-emerald-500/10">Verified</span>
                    </div>
                  </div>
               </div>
            </div>
            ...
            <div className="dashboard-card relative overflow-hidden flex flex-col justify-between group">
               ...
               <div className="relative z-10">
                 ...
                 <h3 className="text-4xl font-black text-on-surface mb-4 tracking-tighter leading-none">Scale Your <br/><span className="text-secondary">Impact</span></h3>
               ...
               <button 
                 ...
                 className="w-full py-5 rounded-2xl bg-white text-black font-black text-xl hover:bg-secondary transition-all relative z-10 shadow-2xl shadow-black/20"
               >
                 Launch New Campaign
               </button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {allCreators.slice(0, 6).map((creator, idx) => (
              <div key={creator._id} className="dashboard-card flex flex-col items-center text-center group transition-all hover:scale-[1.02] border border-outline-variant/10 animate-reveal-up" style={{ animationDelay: `${idx * 0.1}s` }}>
                ...
                <div className={`mt-3 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border shadow-sm ${
                  creator.niche === 'Tech' ? 'niche-tech' :
            ...
            <form onSubmit={handlePostCampaign} className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 pr-6 py-5 bg-surface-container-high border border-outline-variant/10 rounded-2xl outline-none focus:ring-2 focus:ring-secondary/50 font-black text-on-surface text-lg transition-all"
                    placeholder="5000"
                  />
                </div>
              </div>
              <div className="flex flex-col gap-3">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full px-6 py-5 bg-surface-container-high border border-outline-variant/10 rounded-2xl outline-none focus:ring-2 focus:ring-secondary/50 font-black text-on-surface text-lg appearance-none cursor-pointer transition-all"
                  >
              ...
              <div className="flex flex-col gap-3 md:col-span-2">
                ...
                <input 
                  ...
                  className="px-6 py-5 bg-surface-container-high border border-outline-variant/10 rounded-2xl outline-none focus:ring-2 focus:ring-secondary/50 font-black text-on-surface font-medium transition-all"
              ...
              <div className="flex flex-col gap-3 md:col-span-2">
                ...
                <textarea 
                  ...
                  className="px-6 py-6 bg-surface-container-high border border-outline-variant/10 rounded-2xl outline-none h-48 font-medium text-on-surface leading-relaxed transition-all"
      ...
      {activeTab === 'edit' && (
        <div className="max-w-4xl">
          <div className="dashboard-card">
            <h3 className="text-3xl font-black mb-12 tracking-tighter text-on-surface">Brand Identity Settings</h3>
            ...
            <form onSubmit={handleProfileUpdate} className="flex flex-col gap-10">
              <div className="flex flex-col gap-3">
                <label className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.4em]">Official Business Name</label>
                <input 
              ...
              <div className="flex flex-col gap-3">
                <label className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.4em]">Brand Domain / Website</label>
                <input 
              ...
              <div className="flex flex-col gap-3">
                <label className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.4em]">Brand Narrative / Description</label>
                <textarea 
                  value={profile.description} 
                  onChange={(e) => setProfile({...profile, description: e.target.value})}
                  className="px-6 py-6 bg-surface-container-high border border-outline-variant/10 rounded-2xl outline-none h-44 font-medium text-on-surface leading-relaxed transition-all"
                  placeholder="Share your brand's mission and what you look for in creator partnerships..."
                />
              </div>
              <button type="submit" className="py-6 rounded-2xl bg-linear-to-r from-primary to-secondary text-black font-black text-xl shadow-2xl shadow-primary/20 hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-center gap-3">
                 <Save size={24} /> Synchronize Brand Profile
              </button>
            </form>
          </div>
        </div>
